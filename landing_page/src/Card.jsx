              ...
              <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                  ...
                  <div className="group flex flex-col h-full bg-white border border-gray-200 shadow-sm rounded-xl dark:bg-slate-900 dark:border-gray-700 dark:shadow-slate-700/[.7]">
                    <div className="h-20 p-3 flex flex-col justify-center items-center bg-blue-600 rounded-t-xl">
                      <svg
                        className="w-28 h-28"
                        width={56}
                        height={56}
                  ...
                  {/* Card */}
                  <div className="group flex flex-col h-full bg-white border border-gray-200 shadow-sm rounded-xl dark:bg-slate-900 dark:border-gray-700 dark:shadow-slate-700/[.7]">
                    <div className="h-20 p-3 flex flex-col justify-center items-center bg-rose-500 rounded-t-xl">
                      <svg
                        className="w-28 h-28"
                        width={56}
                        height={56}
                    ...
                    <div className="p-4 md:p-6">
                      ...
                      <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-300 dark:hover:text-white">
                      Sponsors or Third Party
                      </h3>
                      <p className="mt-3 text-gray-500">
                      Some of the countries allow blood relatives only to sponsor the student, however in some countries any third party can sponsor the student depends on country to country.
                  ...
                  {/* Card */}
                  <div className="group flex flex-col h-full bg-white border border-gray-200 shadow-sm rounded-xl dark:bg-slate-900 dark:border-gray-700 dark:shadow-slate-700/[.7]">
                    <div className="h-20 p-3  flex flex-col justify-center items-center bg-amber-500 rounded-t-xl">
                      <svg
                        className="w-28 h-28"
                        width={56}
                        height={56}
                    ...
                    <div className="p-4 md:p-6">
                      ...
                      <p className="mt-3 text-gray-500">
                      As per the country law if you are an international student then you have to show one year living expense in advance in your account then only you ll be getting study permit.
                  ...
                  {/* Card */}
                  <div className="group flex flex-col h-full bg-white border border-gray-200 shadow-sm rounded-xl dark:bg-slate-900 dark:border-gray-700 dark:shadow-slate-700/[.7]">
                    <div className="h-20 p-3  flex flex-col justify-center items-center bg-green-500 rounded-t-xl">
                      <svg
                        className="w-28 h-28"
                        width={56}
                        height={56}
                    ...
                    <div className="p-4 md:p-6">
                      ...
                      <p className="mt-3 text-gray-500">
                      Some of the countries allow students to stay back as long as 1-3 years, however some other countries allow only 1 month to 1 year. Depends on country to country.
                  ...
                  {/* Card */}
                  <div className="group flex flex-col h-full bg-white border border-gray-200 shadow-sm rounded-xl dark:bg-slate-900 dark:border-gray-700 dark:shadow-slate-700/[.7]">
                    <div className="h-20 p-3  flex flex-col justify-center items-center bg-indigo-500 rounded-t-xl">
                      <svg
                        className="w-28 h-28"
                        width={56}
                        height={56}
                    ...
                    <div className="p-4 md:p-6">
                      <span className="block mb-1 text-xs font-semibold uppercase text-indigo-500">
                        Slack API
                      </span>
                      <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-300 dark:hover:text-white">
                      Time Required for PR
                      </h3>
                      <p className="mt-3 text-gray-500">
                      Minimum time required for PR in some of the countries 1 year however if we talk about maximum time required is 5 years. Depends on country you are going to study.
                  ...
                  {/* Card */}
                  <div className="group flex flex-col h-full bg-white border border-gray-200 shadow-sm rounded-xl dark:bg-slate-900 dark:border-gray-700 dark:shadow-slate-700/[.7]">
                    <div className="h-20 p-3  flex flex-col justify-center items-center bg-gray-500 rounded-t-xl">
                      <svg
                        className="w-28 h-28"
                        width={56}
                        height={56}
                    ...
                    <div className="p-4 md:p-6">
                      ...
                      <p className="mt-3 text-gray-500">
                      Again, spouse visa also depends on case to case and country to country our team of expert counselor can help you out in that during counselling session.
